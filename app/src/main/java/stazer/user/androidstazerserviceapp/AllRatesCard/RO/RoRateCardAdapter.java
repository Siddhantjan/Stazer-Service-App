...
public class RoRateCardAdapter extends FirebaseRecyclerAdapter<RateModel, RoRateCardAdapter.FridgeRateCardViewHolder> {

    public RoRateCardAdapter(@NonNull FirebaseRecyclerOptions<RateModel> options) {
        super(options);
    }
