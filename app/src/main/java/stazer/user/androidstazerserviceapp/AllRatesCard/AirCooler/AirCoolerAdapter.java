...
public class AirCoolerAdapter extends FirebaseRecyclerAdapter<RateModel, AirCoolerAdapter.AirCoolerRateCardViewHolder> {
    public AirCoolerAdapter(@NonNull FirebaseRecyclerOptions<RateModel> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull AirCoolerRateCardViewHolder holder, int position, @NonNull RateModel model) {
    ...
    @NonNull
    @Override
    public AirCoolerRateCardViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.single_row_rate_view, parent, false);
        return new AirCoolerRateCardViewHolder(view);
    }

    public static class AirCoolerRateCardViewHolder extends RecyclerView.ViewHolder {
        TextView mSparePart, mSparePartCost, mLabourCost;
        ImageView mEdit, mDelete;

        public AirCoolerRateCardViewHolder(@NonNull View itemView) {
            super(itemView);
